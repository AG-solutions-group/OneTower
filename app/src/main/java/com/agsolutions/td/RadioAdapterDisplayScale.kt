...
import com.agsolutions.td.Main.DisplayScale


class RadioAdapterDisplayScale (
    private val radioList: MutableList<String>
    ) :
    RecyclerView.Adapter<RadioAdapterDisplayScale.ExampleViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ExampleViewHolder, position: Int) {
            ...
            holder.itemView.findViewById<TextView>(R.id.radio_view).setTextSize(TypedValue.COMPLEX_UNIT_SP, DisplayScale.scaleTextNews.toFloat())
