...
import com.agsolutions.td.databinding.FragmentDarkTalentBinding

class DarkTalentFragment : Fragment() {

    private var _binding: FragmentDarkTalentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDarkTalentBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            darkRow1Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].darkRow1Item1.toString()
            darkRow1Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].darkRow1Item2.toString()
            darkRow2Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].darkRow2Item1.toString()
            darkRow2Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].darkRow2Item2.toString()
            darkRow3Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].darkRow3Item1.toString()
            darkRow3Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].darkRow3Item2.toString()
            darkRow3Item3ShowTV.text =
                companionList.towerList[companionList.towerClickID].darkRow3Item3.toString()
            darkRow4Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].darkRow4Item1.toString()
            ...
            darkRow1Item1IB.setOnClickListener() {
                ...
                darkUpgradeBTN.setOnClickListener() {
                    ...
                    if (companionList.towerList[companionList.towerClickID].darkRow1Item1 + companionList.towerList[companionList.towerClickID].darkRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                        ...
                        if (companionList.towerList[companionList.towerClickID].darkRow1Item1 == 1) {
                            companionList.towerList[companionList.towerClickID].towerLevelBool =
                                true
            ...
            darkRow2Item1IB.setOnClickListener() {
                ...
                darkDisplayTalentTV.text =
                    "Casts a spell that sometimes causes enemies to run away in fear. Points decrease spell cooldown and increase fear duration. Works against immune. +1%/2%/3% anti-immune."
                    ...
                    darkUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].darkRow2Item1 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].darkRow2Item1 == 1) {
                                companionList.towerList[companionList.towerClickID].darkTalentFear =
                                    true
            ...
            darkRow2Item2IB.setOnClickListener() {
                ...
                darkDisplayTalentTV.text =
                    "10/15/20% Chance on hit to slow target by 20%/25%/30% permanently. Works against immune. +1%/2%/3% anti-immune."
                darkUpgradeBTN.isClickable = false
                    ...
                    darkUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].darkRow2Item2 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].darkRow2Item2 == 1) {
                                companionList.towerList[companionList.towerClickID].slowExtraDark =
                                    20.0f
                                companionList.towerList[companionList.towerClickID].slowExtraChanceDark =
                                    10
                                companionList.towerList[companionList.towerClickID].bonusDmgImmune += 0.01f
                            }
            ...
            darkRow3Item1IB.setOnClickListener() {
                ...
                darkDisplayTalentTV.text =
                    "Adds 10%/15%/20% magic damage each hit. +1%/2%/3% anti-immune."
                darkUpgradeBTN.isClickable = false
                    ...
                    darkUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].darkRow3Item1 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].darkRow3Item1 == 1) {
                                companionList.towerList[companionList.towerClickID].darkMagicDmgPercent =
                                    0.1f
                                companionList.towerList[companionList.towerClickID].bonusDmgImmune += 0.01f
                            }
            ...
            darkRow3Item2IB.setOnClickListener() {
                ...
                darkDisplayTalentTV.text =
                    "Grabs a random unit and reduces maximum hitpoints by 6%/12%/18% per second. +1%/2%/3% anti-immune."
                darkUpgradeBTN.isClickable = false
                    ...
                    darkUpgradeBTN.setOnClickListener() {
                        ...
                        if (companionList.towerList[companionList.towerClickID].darkRow3Item3 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].darkRow3Item3 == 1) {
                                companionList.towerList[companionList.towerClickID].darkDmgDebuff =
                                    0.2f
                                companionList.towerList[companionList.towerClickID].bonusDmgImmune += 0.01f
                            }
            ...
            darkRow4Item1IB.setOnClickListener() {
                ...
                darkDisplayTalentTV.text =
                    "Receive an item that collects souls adding permanent physical damage for each kill. +1%/2%/3% anti-immune. +1 bag space item at 3/3."
                darkUpgradeBTN.isClickable = false
