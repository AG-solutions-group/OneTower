...
class UtilsTalentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        utilsRow2Item1ShowTV.text = companionList.towerList[companionList.towerClickID].utilsRow2Item1.toString()
        utilsRow2Item2ShowTV.text = companionList.towerList[companionList.towerClickID].utilsRow2Item2.toString()
        utilsRow2Item3ShowTV.text = companionList.towerList[companionList.towerClickID].utilsRow2Item3.toString()
        utilsRow3Item1ShowTV.text = companionList.towerList[companionList.towerClickID].utilsRow3Item1.toString()
        ...
        utilsRow1Item1IB.setOnClickListener() {
            ...
            utilsDisplayTalentTV.text = "Gain a small amount of experience each time a tower in 150 range gains experience."
        ...
        utilsRow1Item2IB.setOnClickListener() {
            ...
            utilsDisplayTalentTV.text = "Each time this tower gains experience it shares 10% to all towers in 150 range."
            utilsUpgradeBTN.isClickable = true
