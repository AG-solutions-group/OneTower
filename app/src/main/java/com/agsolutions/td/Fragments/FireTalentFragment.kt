           ...
           setImagePick(11)
            ...
            fireUpgradeBTN.setOnClickListener() {
                ...
                if (companionList.towerList[companionList.towerClickID].fireRow1Item1 + companionList.towerList[companionList.towerClickID].fireRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                    ...
                    if (companionList.towerList[companionList.towerClickID].fireRow1Item1 == 1) companionList.towerList[companionList.towerClickID].experienceFireCrit = true
        ...
        fireRow1Item2IB.setOnClickListener() {
            ...
            fireUpgradeBTN.setOnClickListener() {
                ...
                if (companionList.towerList[companionList.towerClickID].fireRow1Item1 + companionList.towerList[companionList.towerClickID].fireRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                    ...
                    if (companionList.towerList[companionList.towerClickID].fireRow1Item2 == 1) companionList.towerList[companionList.towerClickID].talentFireKill = true
