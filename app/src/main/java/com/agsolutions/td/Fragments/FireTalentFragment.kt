...
import com.agsolutions.td.databinding.FragmentFireTalentBinding


class FireTalentFragment : Fragment() {

    private var _binding: FragmentFireTalentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFireTalentBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            fireRow1Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].fireRow1Item1.toString()
            fireRow1Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].fireRow1Item2.toString()
            fireRow2Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].fireRow2Item1.toString()
            fireRow2Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].fireRow2Item2.toString()
            fireRow3Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].fireRow3Item1.toString()
            fireRow3Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].fireRow3Item2.toString()
            fireRow4Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].fireRow4Item1.toString()
            ...
            fireRow1Item1IB.setOnClickListener() {
                ...
                fireDisplayTalentTV.text =
                    "Gain Experience for each critical strike (10% of enemy)."
                ...
                fireUpgradeBTN.setOnClickListener() {
                    ...
                    if (companionList.towerList[companionList.towerClickID].fireRow1Item1 + companionList.towerList[companionList.towerClickID].fireRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                        ...
                        if (companionList.towerList[companionList.towerClickID].fireRow1Item1 == 1) {
                            companionList.towerList[companionList.towerClickID].experienceFireCrit =
                                true
                            fireRow1Item2IB.isClickable = false
                            fireRow1Item2IBPick.setImageResource(R.drawable.crossedout)
                        }
            ...
            fireRow1Item2IB.setOnClickListener() {
                ...
                fireUpgradeBTN.setOnClickListener() {
                    ...
                    if (companionList.towerList[companionList.towerClickID].fireRow1Item1 + companionList.towerList[companionList.towerClickID].fireRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                        ...
                        if (companionList.towerList[companionList.towerClickID].fireRow1Item2 == 1) {
                            companionList.towerList[companionList.towerClickID].talentFireKill =
                                true
                            fireRow1Item1IB.isClickable = false
                            fireRow1Item1IBPick.setImageResource(R.drawable.crossedout)
                        }
            ...
            fireRow2Item2IB.setOnClickListener() {
                ...
                fireDisplayTalentTV.text =
                    "Burns enemies critically hit for additional 2%/4%/6% of maximum hitpoints as magic damage over 2.4 seconds. Ignores shields. 50% damage to bosses."
                fireUpgradeBTN.isClickable = false
            ...
            fireRow3Item1IB.setOnClickListener() {
                ...
                fireDisplayTalentTV.text =
                    "Each consecutive non-critical hit increases critical damage by 0.05/0.075/0.1. Resets after critical hit."
                fireUpgradeBTN.isClickable = false
                ...
                if (companionList.towerList[companionList.towerClickID].fireRow2Item1 + companionList.towerList[companionList.towerClickID].fireRow2Item2 >= 3) {
                    ...
                    fireUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].fireRow3Item1 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].fireRow3Item1 == 1) companionList.towerList[companionList.towerClickID].bonusCritFire =
                                0.05f
                            if (companionList.towerList[companionList.towerClickID].fireRow3Item1 == 2) companionList.towerList[companionList.towerClickID].bonusCritFire =
                                0.075f
                            if (companionList.towerList[companionList.towerClickID].fireRow3Item1 == 3) companionList.towerList[companionList.towerClickID].bonusCritFire =
                                0.1f
            ...
            fireRow3Item2IB.setOnClickListener() {
                ...
                fireDisplayTalentTV.text =
                    "During day: enemies build up sunburn stacks, which burns enemies. Stacks with Burn ability. Increases day time by 1 hour at 3/3."
                fireUpgradeBTN.isClickable = false
            ...
            fireRow4Item1IB.setOnClickListener() {
                ...
                fireDisplayTalentTV.text =
                    "Increases multicrit count by 0/1/2. Plus 1 multicrit each 20 levels at 3/3. +1 bag space item at 3/3."
                fireUpgradeBTN.isClickable = false
