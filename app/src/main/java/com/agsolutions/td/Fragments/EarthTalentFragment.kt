...
import com.agsolutions.td.databinding.FragmentEarthTalentBinding

class EarthTalentFragment : Fragment() {

    private var _binding: FragmentEarthTalentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEarthTalentBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            earthRow1Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].earthRow1Item1.toString()
            earthRow1Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].earthRow1Item2.toString()
            earthRow2Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].earthRow2Item1.toString()
            earthRow2Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].earthRow2Item2.toString()
            earthRow3Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].earthRow3Item1.toString()
            earthRow3Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].earthRow3Item2.toString()
            earthRow3Item3ShowTV.text =
                companionList.towerList[companionList.towerClickID].earthRow3Item3.toString()
            earthRow4Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].earthRow4Item1.toString()
            ...
            earthRow1Item2IB.setOnClickListener() {
                ...
                earthDisplayTalentTV.text =
                    "Occasionally gain experience when shots hit more than 3 enemies. "
                ...
                earthUpgradeBTN.setOnClickListener() {
                    ...
                    if (companionList.towerList[companionList.towerClickID].earthRow1Item1 + companionList.towerList[companionList.towerClickID].earthRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                        ...
                        if (companionList.towerList[companionList.towerClickID].earthRow1Item2 == 1) {
                            companionList.towerList[companionList.towerClickID].experienceEarthHit =
                                true
                            earthRow1Item1IB.isClickable = false
                            earthRow1Item1IBPick.setImageResource(R.drawable.crossedout)
                        }
            ...
            earthRow2Item1IB.setOnClickListener() {
                ...
                earthDisplayTalentTV.text =
                    "Extends the area of effect to hits. Does not stack with multishot, bounce or BUTTERFLY single target abilites. Only applies debuffs to main target."
            ...
            earthRow2Item2IB.setOnClickListener() {
                ...
                earthDisplayTalentTV.text =
                    "Increases hit chance by 1%/2%/3% and global physical damage by 4/8/12."
                earthUpgradeBTN.isClickable = false
            ...
            earthRow3Item1IB.setOnClickListener() {
                ...
                earthDisplayTalentTV.text =
                    "Throws a boulder each 6/5/4 seconds that stuns enemies and deals physical dmg equal to tower damage * 0.5/0.66/0.75. Spell."
                earthUpgradeBTN.isClickable = false
                    ...
                    earthUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].earthRow3Item1 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].earthRow3Item1 == 1) {
                                companionList.towerList[companionList.towerClickID].throwBoulder =
                                    0.5f
                                companionList.towerList[companionList.towerClickID].throwBoulderTimer =
                                    360
                            }
            ...
            earthRow4Item1IB.setOnClickListener() {
                ...
                earthDisplayTalentTV.text =
                    "Increases physical damage by 10%/20%/30%. +1 bag space item at 3/3."
                earthUpgradeBTN.isClickable = false
