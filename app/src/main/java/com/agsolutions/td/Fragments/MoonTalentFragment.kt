...
class MoonTalentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        moonRow2Item1ShowTV.text = companionList.towerList[companionList.towerClickID].moonRow2Item1.toString()
        moonRow2Item2ShowTV.text = companionList.towerList[companionList.towerClickID].moonRow2Item2.toString()
        moonRow3Item1ShowTV.text = companionList.towerList[companionList.towerClickID].moonRow3Item1.toString()
        ...
        moonRow1Item1IB.setOnClickListener() {
            ...
            moonDisplayTalentTV.text = "Gain experience for each target hit by moonlight at least 3 times. (10% of enemy)"
