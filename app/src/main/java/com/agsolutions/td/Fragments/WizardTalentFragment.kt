...
import com.agsolutions.td.databinding.FragmentWizardTalentBinding


class WizardTalentFragment : Fragment() {

    private var _binding: FragmentWizardTalentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWizardTalentBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            wizardRow1Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].wizardRow1Item1.toString()
            wizardRow1Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].wizardRow1Item2.toString()
            wizardRow2Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].wizardRow2Item1.toString()
            wizardRow2Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].wizardRow2Item2.toString()
            wizardRow2Item3ShowTV.text =
                companionList.towerList[companionList.towerClickID].wizardRow2Item3.toString()
            wizardRow3Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].wizardRow3Item1.toString()
            wizardRow3Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].wizardRow3Item2.toString()
            wizardRow4Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].wizardRow4Item1.toString()
            ...
            wizardRow1Item1IB.setOnClickListener() {
                ...
                wizardUpgradeBTN.setOnClickListener() {
                    ...
                    if (companionList.towerList[companionList.towerClickID].wizardRow1Item1 + companionList.towerList[companionList.towerClickID].wizardRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                        ...
                        if (companionList.towerList[companionList.towerClickID].wizardRow1Item1 == 1) {
                            companionList.towerList[companionList.towerClickID].experienceCast =
                                true
                            wizardRow1Item2IB.isClickable = false
                            wizardRow1Item2IBPick.setImageResource(R.drawable.crossedout)
                        }
            ...
            wizardRow1Item2IB.setOnClickListener() {
                ...
                wizardDisplayTalentTV.text =
                    "Improve tower spell damage by tower level (3% per tower level)."
                ...
                wizardUpgradeBTN.setOnClickListener() {
                    ...
                    if (companionList.towerList[companionList.towerClickID].wizardRow1Item1 + companionList.towerList[companionList.towerClickID].wizardRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                        ...
                        if (companionList.towerList[companionList.towerClickID].wizardRow1Item2 == 1) {
                            companionList.towerList[companionList.towerClickID].talentWizardLvlToDmg =
                                true
                            wizardRow1Item1IB.isClickable = false
                            wizardRow1Item1IBPick.setImageResource(R.drawable.crossedout)
                        }
            ...
            wizardRow2Item1IB.setOnClickListener() {
                ...
                wizardDisplayTalentTV.text =
                    "Throws a lightning bolt on 2 enemies for each missed tower attack for 150/200/250% spelldamage."
                    ...
                    wizardUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].wizardRow2Item1 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].wizardRow2Item1 == 1) {
                                companionList.towerList[companionList.towerClickID].wizardMissedLightning =
                                    true
            ...
            wizardRow2Item2IB.setOnClickListener() {
                ...
                wizardDisplayTalentTV.text =
                    "Decreases magic armor of enemies with type magic armor by 3%/6%/9% & reduces hitpoint regeneration by 3%/6%/9%%. Global."
                wizardUpgradeBTN.isClickable = false
            ...
            wizardRow2Item3IB.setOnClickListener() {
                ...
                wizardDisplayTalentTV.text =
                    "Reduces the cooldown of bomb ability by 1/2/3 seconds and increases damage by 5/10/15 (+10% magic damage)."
                wizardUpgradeBTN.isClickable = false
            ...
            wizardRow3Item1IB.setOnClickListener() {
                ...
                wizardDisplayTalentTV.text =
                    "Each spellcast decreases cooldown of all spellcasts by 3/6/9%."
                wizardUpgradeBTN.isClickable = false
            ...
            wizardRow3Item2IB.setOnClickListener() {
                ...
                wizardDisplayTalentTV.text =
                    "Plants a mine at a random location. CD reduced per level. Mines deals a small amount of damage and slow enemies by 50% for 1.5 seconds-"
                wizardUpgradeBTN.isClickable = false
            ...
            wizardRow4Item1IB.setOnClickListener() {
                ...
                wizardDisplayTalentTV.text =
                    "Casts a chain lightning that jumps to 2/4/6 targets. Increases damage for each enemy killed by chain lightning. +1 bag space item at 3/3." +
                    ...
                    wizardUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].wizardRow4Item1 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].wizardRow4Item1 == 1) {
                                companionList.towerList[companionList.towerClickID].chainLighning =
                                    true
                                companionList.towerList[companionList.towerClickID].chainLightningBounceTargets += 2
                                companionList.towerList[companionList.towerClickID].chainLightningDmg =
                                    0.9f
                                companionList.towerList[companionList.towerClickID].chainLightningTimer =
                                    240f
                            }
