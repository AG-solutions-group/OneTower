...
import com.agsolutions.td.databinding.FragmentWindTalentBinding


class WindTalentFragment : Fragment() {

    private var _binding: FragmentWindTalentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWindTalentBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            windRow1Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].windRow1Item1.toString()
            windRow1Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].windRow1Item2.toString()
            windRow2Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].windRow2Item1.toString()
            windRow2Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].windRow2Item2.toString()
            windRow3Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].windRow3Item1.toString()
            windRow3Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].windRow3Item2.toString()
            windRow3Item3ShowTV.text =
                companionList.towerList[companionList.towerClickID].windRow3Item3.toString()
            windRow4Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].windRow4Item1.toString()
            ...
            windRow1Item1IB.setOnClickListener() {
                ...
                windUpgradeBTN.setOnClickListener() {
                    ...
                    if (companionList.towerList[companionList.towerClickID].windRow1Item1 + companionList.towerList[companionList.towerClickID].windRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                        ...
                        if (companionList.towerList[companionList.towerClickID].windRow1Item1 == 1) {
                            companionList.towerList[companionList.towerClickID].experienceEachHit =
                                true
                            windRow1Item2IB.isClickable = false
                            windRow1Item2IBPick.setImageResource(R.drawable.crossedout)
                        }
            ...
            windRow2Item1IB.setOnClickListener() {
                ...
                windDisplayTalentTV.text =
                    "Debuff damage increased permanently by 10/20/30% after hit."
            ...
            windRow2Item2IB.setOnClickListener() {
                ...
                windDisplayTalentTV.text =
                    "Increases Wind tower range by 10/20/30 units and all towers by 3/6/9 units."
                windUpgradeBTN.isClickable = false
                ...
                if (companionList.towerList[companionList.towerClickID].windRow2Item1 + companionList.towerList[companionList.towerClickID].windRow2Item2 >= 3) {
                    ...
                    windUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].windRow3Item1 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].windRow3Item1 == 1) companionList.towerList[companionList.towerClickID].pushBack =
                                80.0f
                            if (companionList.towerList[companionList.towerClickID].windRow3Item1 == 2) companionList.towerList[companionList.towerClickID].pushBack =
                                120.0f
                            if (companionList.towerList[companionList.towerClickID].windRow3Item1 == 3) companionList.towerList[companionList.towerClickID].pushBack =
                                160.0f
                ...
                if (companionList.towerList[companionList.towerClickID].windRow2Item1 + companionList.towerList[companionList.towerClickID].windRow2Item2 >= 3) {
                    ...
                    windUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].windRow3Item2 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].windRow3Item2 == 1) companionList.tornadoRadius =
                                60.0f
            ...
            windRow3Item3IB.setOnClickListener() {
                ...
                windDisplayTalentTV.text =
                    "Increases attack speed of nearby towers by an additional 5/10/15%"
                windUpgradeBTN.isClickable = false
            ...
            windRow4Item1IB.setOnClickListener() {
                ...
                windDisplayTalentTV.text =
                    "Increases attack speed by 0.5%/1%/1.5% each hit until there is no target in range (Max 100%). Burns 1/2/3% max HP each hit as magic damage. +1 bag space item at 3/3."
                windUpgradeBTN.isClickable = false
