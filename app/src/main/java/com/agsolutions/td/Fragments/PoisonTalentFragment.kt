...
class PoisonTalentFragment : Fragment() {
    ...
    private var _binding: FragmentPoisonTalentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPoisonTalentBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            poisonRow1Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].poisonRow1Item1.toString()
            poisonRow1Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].poisonRow1Item2.toString()
            poisonRow2Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].poisonRow2Item1.toString()
            poisonRow2Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].poisonRow2Item2.toString()
            poisonRow3Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].poisonRow3Item1.toString()
            poisonRow3Item2ShowTV.text =
                companionList.towerList[companionList.towerClickID].poisonRow3Item2.toString()
            poisonRow4Item1ShowTV.text =
                companionList.towerList[companionList.towerClickID].poisonRow4Item1.toString()
            ...
            poisonRow1Item1IB.setOnClickListener() {
                ...
                poisonDisplayTalentTV.text =
                    "Gain experience when enemies die from poison (25% of enemy)."
                ...
                poisonUpgradeBTN.setOnClickListener() {
                    ...
                    if (companionList.towerList[companionList.towerClickID].poisonRow1Item1 + companionList.towerList[companionList.towerClickID].poisonRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                        ...
                        if (companionList.towerList[companionList.towerClickID].poisonRow1Item1 == 1) {
                            companionList.towerList[companionList.towerClickID].experiencePoisonKill =
                                true
                            poisonRow1Item2IB.isClickable = false
                            poisonRow1Item2IBPick.setImageResource(R.drawable.crossedout)
                        }
            ...
            poisonRow1Item2IB.setOnClickListener() {
                ...
                poisonDisplayTalentTV.text =
                    "Increases global dmg percent multiplier by number of enemies poisoned * 3."
                ...
                poisonUpgradeBTN.setOnClickListener() {
                    ...
                    if (companionList.towerList[companionList.towerClickID].poisonRow1Item1 + companionList.towerList[companionList.towerClickID].poisonRow1Item2 < 1 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                        ...
                        if (companionList.towerList[companionList.towerClickID].poisonRow1Item2 == 1) {
                            companionList.towerList[companionList.towerClickID].poisonDmgMultiplier =
                                true
                            poisonRow1Item1IB.isClickable = false
                            poisonRow1Item1IBPick.setImageResource(R.drawable.crossedout)
                        }
            ...
            poisonRow2Item1IB.setOnClickListener() {
                ...
                poisonDisplayTalentTV.text =
                    "Increases the damage of stackable poison debuff by 100%/200%/300%. Max 100 stacks."
            ...
            poisonRow2Item2IB.setOnClickListener() {
                ...
                poisonDisplayTalentTV.text =
                    "Tower increases attack speed for 1.66 seconds every 40/30/20 seconds."
                poisonUpgradeBTN.isClickable = false
                ...
                if (companionList.towerList[companionList.towerClickID].poisonRow1Item1 == 1 || companionList.towerList[companionList.towerClickID].poisonRow1Item2 == 1) {
                    ...
                    poisonUpgradeBTN.setOnClickListener() {
                        if (companionList.towerList[companionList.towerClickID].poisonRow2Item2 <= 2 && companionList.towerList[companionList.towerClickID].talentPoints > 0) {
                            ...
                            if (companionList.towerList[companionList.towerClickID].poisonRow2Item2 == 1) companionList.towerList[companionList.towerClickID].poisonOverload =
                                2400
                            if (companionList.towerList[companionList.towerClickID].poisonRow2Item2 == 2) companionList.towerList[companionList.towerClickID].poisonOverload =
                                1800
                            if (companionList.towerList[companionList.towerClickID].poisonRow2Item2 == 3) companionList.towerList[companionList.towerClickID].poisonOverload =
                                1200
            ...
            poisonRow3Item1IB.setOnClickListener() {
                ...
                poisonDisplayTalentTV.text =
                    "Chance to entangle hit enemies. 50% entangle time for bosses."
                poisonUpgradeBTN.isClickable = false
            ...
            poisonRow3Item2IB.setOnClickListener() {
                ...
                poisonDisplayTalentTV.text =
                    "Infects a random enemy with pestilence. Has a chance to spread to nearby enemies. Deals flat damage on boss and challenge, % damage on all other enemies."
                poisonUpgradeBTN.isClickable = false
            ...
            poisonRow4Item1IB.setOnClickListener() {
                ...
                poisonDisplayTalentTV.text =
                    "Releases a poison cloud over a small area where enemies periodically get poison stacks. +1 bag space item at 3/3."
                poisonUpgradeBTN.isClickable = false
